...
class Convolution : public Layer
{
  ...
  */
  ...
  fmap* pad_input(fmap* input); // Pad input
  fmap* pad_input_fast(fmap* input);
...
class AlexNet : public Layer
{
  ...
  AlexNet();
  fmap* forward_pass(fmap* input_features, int dataflow);
  fmap* test_forward_pass(fmap* input_features, int dataflow);
};
